...
$query = "INSERT INTO PRODUCT VALUES ('$p_id','$p_name','$p_description','$p_market_price','$p_our_price','$folder')";
...
if($data){
    ...
    <META HTTP-EQUIV="refresh" CONTENT="0; URL='http://localhost:8080/basil_jacob/ADMIN_DBMS_project.php'">
    <?php
}else{
    echo "Error";
}
