...
if($total !=0)
{
	...
	while($result =mysqli_fetch_assoc($data))
	{
		echo"<tr  >
            ...
            <td style='background:black'><a href='Payment_Details_Update.php?Payment_Id=$result[Payment_Id]&Amount=$result[Amount]&Payment_Type=$result[Payment_Type]&Discount=$result[Discount].&Credential_Id=$result[Credential_Id]&d_id=$result[D_Id]'>Edit</a></td>
			<td style='background:blue;'><a href='Payment_Table_Delete.php?Payment_Id=$result[Payment_Id]' onclick='return checkdelete()'>Delete</a></td>
		</tr>";
	}
}
